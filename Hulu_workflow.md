...
```
    ...
    ## 22:04:55 UMAP embedding parameters a = 0.9922 b = 1.112

    ## 22:04:55 Read 3856 rows and found 50 numeric columns

    ## 22:04:55 Using Annoy for neighbor search, n_neighbors = 30
    ...
    ## **************************************************|
    ## 22:04:56 Writing NN index file to temp file /var/folders/8h/nlcjp3m90839bs8hs2n2jvx40000gp/T//Rtmp5adogB/file1230e7b8ed289
    ## 22:04:56 Searching Annoy index using 1 thread, search_k = 3000
    ## 22:04:56 Annoy recall = 100%
    ## 22:04:57 Commencing smooth kNN distance calibration using 1 thread with target n_neighbors = 30
    ## 22:04:58 Initializing from normalized Laplacian + noise (using RSpectra)
    ## 22:04:58 Commencing optimization for 500 epochs, with 167236 positive edges
    ## 22:05:04 Optimization finished
